...
library(readxl)
library(kableExtra)
type <- read_excel("source/taxonomie_2021-03-17.xlsx",
          sheet = 2)
...
html.results = cat(paste0("<h5><strong>", type[row, 1],
    "</strong></h5><p>", type[row, 3],
    "</p><p><strong>Example:</strong>: ", type[row, 4],
    "</p>"))
}
```
...
library(readxl)
level = read_excel("source/taxonomie_2021-03-17.xlsx",
            sheet = 3)
